...
<?php
	...
	$sql1= "UPDATE class_test SET recommend=recommend + 1 WHERE primeNum = '".$q."' ";	
	
	mysqli_query($con, $sql1);
	
	//여기 두번째 쿼리를 손대야한다. 
	
	$sql2="SELECT * FROM class_test WHERE department ='".$department."' ORDER BY recommend DESC LIMIT 100 ";
	...
	echo '<tr class="line-rankbox">
					...
					<button type="button" name="'.$row['num'].'" onclick="upRecommend('.$row['primeNum'].')"><img class="recommend-button" src="images/button_recommend_up자산 6@216x.png" alt="추천 "> </button>
